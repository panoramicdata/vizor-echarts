...
public partial class XAxis
{
	...
	/// Category data can be auto retrieved from series.data or dataset.source , or can be specified via xAxis.data .
	///   
	...
	/// <summary>
	/// z value of all graphical elements in x axis, which controls order of drawing graphical components.
