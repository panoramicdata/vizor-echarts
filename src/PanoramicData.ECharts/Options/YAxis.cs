...
public partial class YAxis
{
	...
	/// <summary>
	/// The index of grid which the y axis belongs to.
	...
	[DefaultValue("left")]
	public LeftOrRight? Position { get; set; } 

	/// <summary>
	/// Offset of y axis relative to default position.
	/// Useful when multiple y axis has same position value.
	/// Notice: Set yAxis.axisLine.onZero to false to activate this option.
	/// </summary>
	...
	/// Category data can be auto retrieved from series.data or dataset.source , or can be specified via yAxis.data .
	///   
	...
	/// <summary>
	/// z value of all graphical elements in y axis, which controls order of drawing graphical components.
