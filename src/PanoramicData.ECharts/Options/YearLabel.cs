...
public partial class YearLabel
{
	/// <summary>
	...
	///  
	/// Default:
	/// when orient is set as horizontal , position is left when orient is set as vertical , position is top  
	...
	/// Examples:  // Use string template; eg: ['2017-10-11', '2018-01-21']
	/// /*
	///     template variables:
