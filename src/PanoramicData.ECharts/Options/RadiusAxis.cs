...
public partial class RadiusAxis
{
	/// <summary>
	...
	/// It's the first axis by default.
	/// </summary>
	...
	/// Category data can be auto retrieved from series.data or dataset.source , or can be specified via radiusAxis.data .
	///   
