...
internal class TypeCollection
{
	...
	public TypeCollection()
	{
		...
		AddMappedEnumType(new MappedEnumType("borderRadius", typeof(CircleRadius)));
		...
		AddMappedEnumType(new MappedEnumType("textBorderRadius", typeof(CircleRadius)));
		...
		AddMappedEnumType(new MappedEnumType("tooltipRenderMode", typeof(TooltipRenderMode)));
		...
		AddMappedEnumType(new MappedEnumType("center", typeof(CircleRadius)), "PieSeries");
